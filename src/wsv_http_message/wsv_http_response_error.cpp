...
static char			g_wsv_error_400[] =
{
	...
	"<hr><center>wsv (.DRAFT VERSION)</center>\n"
	"</body>\n"
	"</html>\n"
};
...
wsv_http_error_default(int status_code, struct wsv_http_message_s* m)
{
	static char*	wsv_http_errors[][2] =
	{
		...
		{ 0, 0 }, /* empty cell */
		{ 0, 0 }, /* empty cell */
		{ g_wsv_error_400, g_wsv_error_400 + 174 },
		{ g_wsv_error_404, g_wsv_error_404 + 170 },
		{ g_wsv_error_405, g_wsv_error_405 + 188 },
		{ g_wsv_error_411, g_wsv_error_411 + 182 },
		{ g_wsv_error_413, g_wsv_error_413 + 186 },
		{ g_wsv_error_414, g_wsv_error_414 + 176 },
		{ g_wsv_error_500, g_wsv_error_500 + 194 },
		{ g_wsv_error_501, g_wsv_error_501 + 182 },
		{ g_wsv_error_505, g_wsv_error_505 + 204 }
	};
	char*			first;
	char*			last;
					  ...
					  const char* error_page)
{
	...
	if (wsv_stat(error_page, &statbuf) == -1 ||
